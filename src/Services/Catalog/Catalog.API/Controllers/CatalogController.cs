...
namespace Catalog.API.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        public CatalogController(IProductFinder productFinder, IProductRepository productRepository, ILogger<CatalogController> logger)
        {
        ...
        {
            var product = await _productFinder.GetByIdAsync(id);
            if (product == null)
            {
        ...
        {
            var products = await _productFinder.GetByCategoryNameAsync(category);
            return Ok(products);
        }
